ALTER TABLE `annual_goals` ADD `user_id` text;--> statement-breakpoint
CREATE INDEX `annual_goals_user_idx` ON `annual_goals` (`user_id`);--> statement-breakpoint
ALTER TABLE `books` ADD `user_id` text;--> statement-breakpoint
